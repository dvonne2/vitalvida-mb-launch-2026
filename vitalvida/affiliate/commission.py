...
Affiliate Commission Event — the OPERATIONAL truth, available immediately.

Its one authoritative consequence is a Purchase Invoice — the FINANCIAL truth,
auditable and party-tracked. Accounting consumes the event; it does not replace
it. Media buyers are paid exactly as delivery agents and suppliers are: accounts
payable.
...
def record_commission_earned(order_name):
    """Record the earned-commission fact and accrue it as a Purchase Invoice.
