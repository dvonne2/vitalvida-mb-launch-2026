"""Consumer Activation Approval Event — immutable approval evidence.
...
FROZEN_FIELDS = {'source_key', 'activation_request', 'approved_change_hash', 'approved_by', 'approved_at', 'notes'}


class ConsumerActivationApprovalEvent(Document):
    def validate(self):
